...
| ------------ | ---------------------------- | ---------------------------------------------------- | ------------------------- | ----------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| Jest         | Unit nad Integration testing | Dev Server, Pre-Commit, Individual                   | dev, hooks, test, reports | [Jest CLI](https://jestjs.io/docs/cli) installed (run `npx jest`) | [Jest](https://marketplace.visualstudio.com/items?itemName=Orta.vscode-jest)                               |
